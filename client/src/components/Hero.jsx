...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden bg-[#130608] py-[60px] md:py-[80px]">
      ...
      <div className="relative z-10 w-full max-w-[800px] mx-auto px-[24px] text-center flex flex-col items-center gap-[32px]">
        ...
        <motion.p
          ...
          className="text-[16px] sm:text-[19px] text-[#FECACA]/70 font-[600] max-w-[560px] leading-[1.65]"
        >
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-[8px] sm:gap-[0px] flex-wrap sm:divide-x sm:divide-[#F87171]/20 mt-[8px]"
        >
          {stats.map(({ icon: Icon, value, label }) => (
            <div key={label} className="flex items-center gap-[10px] px-[20px] sm:px-[28px] py-[10px]">
              ...
              <div className="text-left">
                ...
                <div className="text-[11px] font-[700] text-[#FECACA]/50 uppercase tracking-wider mt-[2px]">{label}</div>
              </div>
            </div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="flex items-center gap-[18px] flex-wrap justify-center mt-[4px]"
        >
          {[
            ...
            <div key={text} className="flex items-center gap-[6px] text-[12px] font-[700] text-[#FECACA]/40">
